...
path= letRun.path
skin=sk.Skin(videoFile=path+NAME)#videoFile=path+"push.avi" videoFile=path+"small1.avi" #load skin object using demo video
...
np.save("C:/Users/dexte/github/RoboSkin/Code/Models/labeller/X_data_slip",X)
np.save("C:/Users/dexte/github/RoboSkin/Code/Models/labeller/y_data_slip",y)
